...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-5.justify-content-center
      ...
      .col-xl-5.p-5.bgr_4.d-flex.align-items-center
        div
          ...
          p.mb-0 El sistema cede energía hacía el medio en forma de calor. Ejemplo, la condensación, la solidificación y la sublimación regresiva. A continuación, se indica su proceso en la siguiente figura.
    ...
    .row.mb-5.justify-content-center
      .col-lg-8.col-xl-6
        ...
        figure
          ...
          figcaption Nota. Tomada de Arroyo (2014)
    
    p A condiciones extremas de presión y temperatura, la materia puede comportarse de forma atípica, lo que ha llevado a los científicos a denominar y presumir la existencia de estados de agregación adicionales que, en condiciones naturales de la tierra, resulta improbable que ocurran, a menos que se logre acondicionar y controlar favorablemente las variables del medio. Algunos de estos son: plasma, fluido supercrítico, condensado de Bose-Einstein, condensado de Fermi, supersólido, cristal líquido, entre otros, y aún motivo de discusión científica.
    p.mb-5.text-center La materia, en términos generales y de acuerdo con su composición, puede clasificarse en:
      ...
      AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta bgr_5")
        .row(titulo="Mezcla").p-4.text-white
          ...
          .col-md-8.mb-4.mb-md-0.d-flex.align-items-center
            div
              p.text-bold Heterogéneas
              p Son aquellas mezclas en las que sus componentes se pueden diferenciar a simple vista.
              p.text-bold Homogéneas
              p.mb-0 Son aquellas mezclas cuyos componentes no se pueden diferenciar a simple vista. Las mezclas homogéneas de líquidos se conocen con el nombre de soluciones y están constituidas por un soluto y un solvente, siendo el primero el que se encuentra en menor proporción y además suele ser el líquido. Como en el ejemplo.
      ...
      .row.mb-5
        ...
        .col-xl-4
          .bgr_1.p-4.h-100
            ...
            .text-center
              h4 Ordinal
              p Las variables se distinguen por categorías o etiquetas y estas, a su vez, ser asociadas a un grado u orden específico. Por ejemplo, grado de escolaridad, grado de satisfacción de un servicio, entre otras.
    ...
    .bg_grad_06
      ...
      .row.tarjeta.bgr_3.p-4.mb-5
        .col-xl-5
          figure.d-flex.justify-content-center
            img.w-auto(src='@/assets/curso/tema2/img41.png')
        .col-xl-7.position-relative
          hr.bgr_11
          .bg_grad_07
            p.ms-4 “La ciencia que tiene por objeto el estudio de las propiedades medibles, las escalas de medida, los sistemas de unidades, los métodos y técnicas de medición, así como la evolución de lo anterior, la valoración de la calidad de las mediciones y su mejora constante, facilitando el progreso científico, el desarrollo tecnológico, el bienestar social y la calidad de vida”.
            p.text-end.me-5 (INM,2021)
          img.w-auto.psta(src='@/assets/curso/tema2/img42.svg')
          img.w-auto.psta_1(src='@/assets/curso/tema2/img43.svg')
      ...
      .row.mb-5.justify-content-center
        .col-xl-3
          .titulo-sexto.color-acento-contenido
            h5 Tabla 3
            span Factores unitarios de conversión
          .tabla-a.mb-5 
          table.text-center.bgr_13
            tbody
              tr
                td.text-bold 1 in = 2,54 cm
              tr
                td.text-bold 1 kg = 2,205 lb
              tr
                td.text-bold 1 mi = 1,609 km
              tr
                td.text-bold 1 m = 0,001 km
              tr
                td.text-bold 1 h = 3.600 s
              tr
                td.text-bold 1 g = 1.000 mg
              tr
                td.text-bold 1 Hm = 100 m
              tr
    ...
    .row.mb-5
      ...
      .col-xl-4
        figure.d-flex.justify-content-center
          img.w-auto(src='@/assets/curso/tema2/img46.svg')
    
    TabsA.color-acento-contenido.mb-5
      .row.tarjeta.color-acento-botones--borde.p-4(titulo="Escala Celsius")
        .col-xl-8
          h4 Escala Celsius (°C)
          p Toma como referencia los puntos de fusión (0°C) y ebullición (100 °C) del agua para establecer su escala.
        .col-xl-4
          figure.d-flex.justify-content-center
            img.w-auto(src='@/assets/curso/tema2/img47.svg')
      .row.tarjeta.color-acento-botones--borde.p-4(titulo="Escala Fahrenheit")
        .col-xl-8
          h4 Escala Fahrenheit (°F)
          p Esta escala establece el punto de congelación del agua en 32°F y ebullición en 212°F.
        .col-xl-4
          figure.d-flex.justify-content-center
            img.w-auto(src='@/assets/curso/tema2/img48.svg')
      .row.tarjeta.color-acento-botones--borde.p-4(titulo="Escala Kelvin")
        .col-xl-8
          h4 Escala Kelvin
          p Es una escala absoluta, donde su cero (0 K) corresponde al valor mínimo teórico de energía interna que puede tener un sistema. Fue adoptada como la unidad fundamental de temperatura por el S.I. Kelvin, al ser una escala absoluta, no conviene expresarla con el componente de grados (°).
        .col-xl-4
          figure.d-flex.justify-content-center
            img.w-auto(src='@/assets/curso/tema2/img49.svg')
